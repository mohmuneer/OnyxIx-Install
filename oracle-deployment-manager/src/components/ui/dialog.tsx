  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 outline-none",
        ...
        {...props}
      >
        <div className="relative flex max-h-full w-full max-w-lg flex-col overflow-hidden rounded-xl bg-popover p-4 text-sm text-popover-foreground ring-1 ring-foreground/10">
          {children}
          {showCloseButton && (
